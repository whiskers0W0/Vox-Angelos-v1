...
namespace VoxAngelos.Migrations
{
    ...
    [Migration("20260813083723_AddOcrNameAndMunicipalityFields")]
    partial class AddOcrNameAndMunicipalityFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VoxAngelos.Data.AdminRoutingAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("Department", "AssignedAt");

                    b.HasIndex("SubmissionType", "SubmissionId")
                        .IsUnique();

                    b.ToTable("AdminRoutingAssignments");
                });
            ...
            modelBuilder.Entity("VoxAngelos.Data.ClassificationCorrection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ClassificationCorrections");
                });
            ...
            modelBuilder.Entity("VoxAngelos.Data.Concern", b =>
                {
                    ...
                    b.Property<string>("AssignedOffice")
                        .HasColumnType("text");
                    ...
                    b.Property<int>("LocationDensityScore")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("VoxAngelos.Data.ConcernTimelineEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ConcernId", "CreatedAt");

                    b.ToTable("ConcernTimelineEvents");
                });

            modelBuilder.Entity("VoxAngelos.Data.LearnedKeyword", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("Word", "Department")
                        .IsUnique();

                    b.ToTable("LearnedKeywords");
                });
            ...
            modelBuilder.Entity("VoxAngelos.Data.Recommendation", b =>
                {
                    ...
                    b.Property<double>("AvgFeasibility")
                        .HasColumnType("double precision");

                    b.Property<double>("AvgRelevance")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("VoxAngelos.Data.RecommendationRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("FeasibilityStars")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("RelevanceStars")
                        .HasColumnType("integer");

                    b.Property<DateTime?>("UpdatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("UrgencyStars")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("VoxAngelos.Data.UserFaceVerification", b =>
                {
                    ...
                    b.Property<string>("LiveSelfieCloudinaryFormat")
                        .HasColumnType("text");

                    b.Property<string>("LiveSelfieCloudinaryPublicId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("VoxAngelos.Data.UserIdentityDocument", b =>
                {
                    ...
                    b.Property<string>("CloudinaryLastUploadError")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<DateTime?>("CloudinaryNextRetryAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("IdPhotoCloudinaryPublicId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("VoxAngelos.Data.UserNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("VoxAngelos.Data.UserOcrVerification", b =>
                {
                    ...
                    b.Property<bool>("CityProvinceMatched")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("DetectedMunicipality")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("VoxAngelos.Data.ClassificationCorrection", b =>
                {
                    ...
                    b.HasOne("VoxAngelos.Data.ApplicationUser", "ReviewedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("VoxAngelos.Data.UserNotification", b =>
                {
                    b.HasOne("VoxAngelos.Data.ApplicationUser", "RecipientUser")
                        .WithMany()
